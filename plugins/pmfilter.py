   ...
   # await message.react(random.choice(REACTIONS))
    ...
    if message.chat.id != SUPPORT_CHAT_ID:
        ...
        if total_results == 0:
            ...
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🔍 ᴊᴏɪɴ ᴀɴᴅ ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url=f"https://t.me/+FH_ioO0iFpoyNDFl")]]))
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/+FH_ioO0iFpoyNDFl")]])
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("🔍 ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url="https://t.me/+FH_ioO0iFpoyNDFl")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
...
#Deendayal403
        ...
        buttons = [[           
            InlineKeyboardButton('ᴍᴏᴠɪᴇ  ᴄʜᴀɴɴᴇʟ ', url="https://t.me/+FH_ioO0iFpoyNDFl"),
            InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url="https://t.me/+FH_ioO0iFpoyNDFl")
        ],[
            InlineKeyboardButton('⚜️ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ ⚜️', url="https://t.me/movietrixbotrequest"),
